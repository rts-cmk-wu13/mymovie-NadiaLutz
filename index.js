document.addEventListener('DOMContentLoaded', () => {
  ...
  movieListContainer.innerHTML = `
    <div class="movielist__top">
      <h2>Now Showing</h2>
      <button id="seemoreBtn" class="seemore__btn" id="seemore__btn-now">
        <a href="showmore_now.html">See more</a>
      </button>
    </div>
  `;
  ...
  popularListContainer.innerHTML = `
    <div class="popularlist__top">
      <h2>Popular</h2>
      <button id="seemoreBtn" class="seemore__btn" id="seemore__btn-popular">
        <a href="showmore_popular.html">See more</a>
      </button>
    </div>
  `;
